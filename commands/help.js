...
> \`avatar\`, \`ping\`, \`youtubedownload\`, \`emojilist\`, \`downloader\`, \`help\`, \`pinterest\`, \`movie\`, \`say\`, \`remindme\`, \`cancelremind\`, \`listreminder\`, \`snipe\`, \`google\`, \`ytstats\`, \`afk\`, \`nasa\`, \`cuddle\`, \`hug\`, \`kiss\`, \`pat\`, \`slap\`, \`youtube\`` },
                { name: '<:shield:885185036419219496> Moderation Commands & Slash Commands', value: stripIndents`
> \`setprefix\`, \`setlanguage\`, \`reloadcommands\`, \`blacklist\`, \`reactionrole-add\`, \`reactionrole-remove\`, \`automod-flaggedword\`, \`automod-keyword\`, \`automod-mentionspam\`, \`ban\`, \`kick\`, \`setlanguage\`, \`setprefix\`, \`clear\`, \`addemoji\`, \`confession-delete\`, \`confession-blacklist\`, \`confession-remove\`, \`confession-setup\`, \`confession-unblacklist\`, \`eval\`, \`backup\`, \`kick\`, \`ban\`, \`giveaway\`, \`nuke\`, \`unban\`, \`reminder\`, \`removeremind\`` },
                { name: "<:chart:885185036419219496> Slash "+ lang(msg.guild, "COMMANDS"), value: stripIndents`
> \`avatar\`, \`imagine\`, \`confess\`, \`bmkg\`, \`translate\`, \`serveravatar\`, \`playstore\`, \`appstore\`, \`leaderboard\`, \`lyrics\`, \`movie\`, \`pinterest\`, \`youtubedownload\`` },
