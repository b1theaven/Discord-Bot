...
exports.CacheServiceClient = void 0;
 ...
 */
const gapicConfig = require("./cache_service_client_config.json");
...
class CacheServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listCachedContents: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'cachedContents'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1beta.CacheService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.cacheServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.ai.generativelanguage.v1beta.CacheService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.ai.generativelanguage.v1beta
                    .CacheService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of cacheServiceStubMethods) {
            const callPromise = this.cacheServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createCachedContent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    getCachedContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateCachedContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'cached_content.name': (_a = request.cachedContent.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateCachedContent(request, options, callback);
    }
    deleteCachedContent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listCachedContents(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listCachedContentsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listCachedContents.createStream(this.innerApiCalls.listCachedContents, request, callSettings);
    }
    /**
    ...
    listCachedContentsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listCachedContents.asyncIterate(this.innerApiCalls['listCachedContents'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=cache_service_client.js.map